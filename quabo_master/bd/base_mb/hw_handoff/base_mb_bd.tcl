...
# module references:
# IBUFDS_FOR_CLK, IM_FIFO, OBUFDS_FOR_CLK, PPS_IO, SPI_MUX, SPI_STARTUP, SPI_access, StepDrive_ShutterCtrl_Sel, TAI_IO, delay, delay, elapsed_time_gen, ext_trig, firmware_ID_ROM, flash_control, in_buf_ds_1bit, in_buf_ds_4bit, in_buf_ds_1bit, pinout_three_state, step_drive, stim_gen
...
proc create_root_design { parentCell } {
  ...
  set ext_trig_io_0 [ create_bd_port -dir IO ext_trig_io_0 ]
  ...
  set pps_inout_0 [ create_bd_port -dir IO pps_inout_0 ]
  set sd0_sc [ create_bd_port -dir O sd0_sc ]
  set sd1_ss [ create_bd_port -dir IO sd1_ss ]
  set sd2_spare [ create_bd_port -dir O sd2_spare ]
  set sd3_lss [ create_bd_port -dir IO sd3_lss ]
  ...
  set AXI_Stream_Switch_3_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_Stream_Switch_3:1.3 AXI_Stream_Switch_3_0 ]

  # Create instance: AXI_Stream_Switch_3_1, and set properties
  set AXI_Stream_Switch_3_1 [ create_bd_cell -type ip -vlnv user.org:user:AXI_Stream_Switch_3:1.3 AXI_Stream_Switch_3_1 ]
  ...
  # Create instance: Bit_29_24, and set properties
  set Bit_29_24 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 Bit_29_24 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {29} \
   CONFIG.DIN_TO {24} \
   CONFIG.DIN_WIDTH {32} \
  ...
  # Create instance: Bit_3_0, and set properties
  set Bit_3_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 Bit_3_0 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {3} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {32} \
  ...
  set ETH_CORE_CTRL_0 [ create_bd_cell -type ip -vlnv user.org:user:ETH_CORE_CTRL:2.1 ETH_CORE_CTRL_0 ]

  # Create instance: ETH_CORE_CTRL_1, and set properties
  set ETH_CORE_CTRL_1 [ create_bd_cell -type ip -vlnv user.org:user:ETH_CORE_CTRL:2.1 ETH_CORE_CTRL_1 ]

  # Create instance: FIFO_for_AXIS_0, and set properties
  set FIFO_for_AXIS_0 [ create_bd_cell -type ip -vlnv user.org:user:FIFO_for_AXIS:1.4 FIFO_for_AXIS_0 ]
  ...
  # Create instance: IM_FIFO_0, and set properties
  set block_name IM_FIFO
  set block_cell_name IM_FIFO_0
  if { [catch {set IM_FIFO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $IM_FIFO_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  set block_cell_name PPS_IO_0
  if { [catch {set PPS_IO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PPS_IO_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: StepDrive_ShutterCtr_0, and set properties
  set block_name StepDrive_ShutterCtrl_Sel
  set block_cell_name StepDrive_ShutterCtr_0
  if { [catch {set StepDrive_ShutterCtr_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
  ...
  # Create instance: ext_trig_0, and set properties
  set block_name ext_trig
  set block_cell_name ext_trig_0
  if { [catch {set ext_trig_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ext_trig_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: firmware_ID_ROM_0, and set properties
  set block_name firmware_ID_ROM
  set block_cell_name firmware_ID_ROM_0
  if { [catch {set firmware_ID_ROM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $firmware_ID_ROM_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: pinout_three_state_0, and set properties
  set block_name pinout_three_state
  set block_cell_name pinout_three_state_0
  if { [catch {set pinout_three_state_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pinout_three_state_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: step_drive_0, and set properties
  set block_name step_drive
  set block_cell_name step_drive_0
  if { [catch {set step_drive_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $step_drive_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXI_Stream_Switch_3_0_M0_AXIS [get_bd_intf_pins AXI_Stream_Switch_3_0/M0_AXIS] [get_bd_intf_pins ETH_CORE_CTRL_1/s_axis_txd]
  connect_bd_intf_net -intf_net AXI_Stream_Switch_3_1_M0_AXIS [get_bd_intf_pins AXI_Stream_Switch_3_0/S2_AXIS] [get_bd_intf_pins AXI_Stream_Switch_3_1/M0_AXIS]
  ...
  connect_bd_intf_net -intf_net FIFO_for_AXIS_0_m_axis [get_bd_intf_pins AXI_Stream_Switch_3_0/S1_AXIS] [get_bd_intf_pins FIFO_for_AXIS_0/m_axis]
  connect_bd_intf_net -intf_net HighSpeed_IM_v1_0_0_m_axis [get_bd_intf_pins AXI_Stream_Switch_3_1/S0_AXIS] [get_bd_intf_pins HighSpeed_IM_v1_0_0/m_axis]
  connect_bd_intf_net -intf_net HighSpeed_PH_v1_0_0_m_axis [get_bd_intf_pins AXI_Stream_Switch_3_1/S1_AXIS] [get_bd_intf_pins HighSpeed_PH_v1_0_0/m_axis]
  connect_bd_intf_net -intf_net axi_ethernet_0_fifo_AXI_STR_TXD [get_bd_intf_pins AXI_Stream_Switch_3_0/S0_AXIS] [get_bd_intf_pins axi_ethernet_0_fifo/AXI_STR_TXD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins HighSpeed_IM_v1_0_0/s_axi_packetheader] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins PH_BL_FIFO_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  connect_bd_intf_net -intf_net maroc_dc_0_M00_AXIS [get_bd_intf_pins IM_FIFO_0/axi_str_rxd] [get_bd_intf_pins maroc_dc_0/M00_AXIS]
  connect_bd_intf_net -intf_net maroc_dc_0_M01_AXIS [get_bd_intf_pins PH_BL_FIFO_0/axi_str_rxd] [get_bd_intf_pins maroc_dc_0/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins HighSpeed_PH_v1_0_0/s_axi_packetheader] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  ...
  connect_bd_net -net In7_0_1 [get_bd_ports PCBrev_n] [get_bd_pins xlconcat_2/In7]
  ...
  connect_bd_net -net Net8 [get_bd_ports ext_trig_io_0] [get_bd_pins ext_trig_0/ext_trig_io]
  ...
  connect_bd_net -net StepDrive_ShutterCtr_0_light_sensor_status [get_bd_pins StepDrive_ShutterCtr_0/light_sensor_status] [get_bd_pins xlconcat_2/In6]
  ...
  connect_bd_net -net clk_wiz_0_clk_62m5 [get_bd_pins clk_wiz_0/clk_62m5] [get_bd_pins delay_0/clk] [get_bd_pins delay_1/clk] [get_bd_pins elapsed_time_gen_0/clk_62m5]
  ...
  connect_bd_net -net ext_trig_0_ext_trig_maroc [get_bd_pins ext_trig_0/ext_trig_maroc] [get_bd_pins maroc_dc_0/ext_trig]
  connect_bd_net -net firmware_ID_ROM_0_data_out [get_bd_pins firmware_ID_ROM_0/data_out] [get_bd_pins xlconcat_2/In4]
  ...
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports board_loc] [get_bd_pins GPIO/gpio2_io_i] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net maroc_dc_0_pixel_trig [get_bd_pins ext_trig_0/pixel_trig_maroc] [get_bd_pins maroc_dc_0/pixel_trig]
  ...
  connect_bd_net -net step_drive_0_drive_out [get_bd_pins StepDrive_ShutterCtr_0/step_drive] [get_bd_pins step_drive_0/drive_out]
  ...
  connect_bd_net -net sysclkin_n_1 [get_bd_ports sysclkin_n] [get_bd_pins IBUFDS_FOR_CLK_0/IB]
  ...
  connect_bd_net -net wrc_board_quabo_Light_0_pps_o [get_bd_pins delay_1/din] [get_bd_pins wrc_board_quabo_Light_0/pps_o]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs HighSpeed_IM_v1_0_0/s_axi_packetheader/reg0] SEG_HighSpeed_IM_v1_0_0_reg03
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs HighSpeed_PH_v1_0_0/s_axi_packetheader/reg0] SEG_HighSpeed_PH_v1_0_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs HighSpeed_PH_v1_0_0/s_axi_packetheader/reg0] SEG_HighSpeed_PH_v1_0_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PH_BL_FIFO_0/S00_AXI/S00_AXI_reg] SEG_PH_BL_FIFO_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PH_BL_FIFO_0/S00_AXI/S00_AXI_reg] SEG_PH_BL_FIFO_0_S00_AXI_reg
